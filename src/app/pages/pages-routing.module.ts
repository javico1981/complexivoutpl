...
const routes: Routes = [
    ...
    { path: '', 
      ...
      children: [
        ...
        { path: 'citas-medicas-calificacion', loadChildren: () => import('./main-page/citas-medicas-calificacion/citas-medicas-calificacion.module').then(m=>m.CitasMedicasCalificacionModule),
          canActivate: [ RolGuard ],
          data: { usersEnabled: [environment.roles.administrador.id] }
        },
          { 
