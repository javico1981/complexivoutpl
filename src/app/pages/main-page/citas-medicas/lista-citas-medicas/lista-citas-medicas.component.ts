...
export class ListaCitasMedicasComponent implements OnInit, OnDestroy {
  ...
  calificar(event: any, citaMedica: CitaMedica): void {
    const citaMedicaEdit = citaMedica;
    citaMedicaEdit.calificacion = event;
    citaMedicaEdit.calificacionNumber = parseInt(event, 10);
    this.citasMedicasService.updateCitaMedica(citaMedicaEdit, citaMedicaEdit.id);
  }
